...
plt.plot(np.sort(X_train.reshape(X_train.shape[1])),
        ...
        color='red', label='Fitted line', linewidth = 4)
...
filename = f"result_cos_tag0_{max_hidden_unit}_{nN}.csv"
...
filename1 = f"result_cos_tag1_{max_hidden_unit}_{nN}.csv"
